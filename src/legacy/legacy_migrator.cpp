...
/* ============================================================================
 * v0050 -> current (0x0050 -> 0x0060)
 * The 0x0060 bump APPENDED button_t shift_buttons[] at the end and repurposed the
 ...
 * into the dedicated shift_buttons[] so shifts survive the 0x0060 move. */
