...
* **MCP23017 I2C GPIO expander configuration** — on the Shift Registers tab, up to 4 chips (I2C address `0x20`–`0x27`, 16 buttons each) with per-chip button count, internal pull-ups, and invert; duplicate-address clashes are flagged. The expander buttons surface in the Buttons-tab Physical panel as *I2C expander N*, mappable with every Function type
